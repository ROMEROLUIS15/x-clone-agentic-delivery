...
async function main() {
  ...
  const tweetsData = [
    ...
    { userId: users[2].id, text: "Building a game engine in Rust for fun. Current feature: rendering a triangle. Living the dream." },
    ...
    { userId: users[5].id, text: "Hiked 15 miles today to clear my head. Came back and fixed a bug in 5 minutes. Nature is the best debugger." },
    ...
    { userId: users[10].id, text: "Migrated our entire infrastructure to serverless. Costs down 60%, team morale up 200%. #AWS #serverless" },
